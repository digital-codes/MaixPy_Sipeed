...
![MaixHub 手动部署页面](../../assets/maixhub_train_manual_deploy_page.png)
...
![MaixHub 模型压缩包内容](../../assets/maixhub_train_manual_deploy_package.png)

打开 MaixVision 并连接设备，进入左侧“设备文件管理器”。在设备端进入 `/root/models` 目录，用于存放模型文件。

![MaixVision 设备文件管理器](../../assets/maixhub_train_manual_deploy_maixvision.png)
...
![上传 MaixHub 模型文件](../../assets/maixhub_train_manual_deploy_upload.png)
...
![MaixHub 模型设备端运行效果](../../assets/maixhub_train_manual_deploy_result.png)
